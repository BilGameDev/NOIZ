...
Haptic Feedback - Satisfying vibration feedback on cuts (Nice Vibrations)

Visual Effects - Particle systems and DOTween animations

🎵 How It Works
Search for an artist in the lobby

Select up to 5 tracks to play

Cut notes as they approach the cut zone

Match the swipe direction shown on each note

Build combos and achieve high scores
...
Install required packages (DOTween, Input System)

Press Play - the game will automatically load tracks
